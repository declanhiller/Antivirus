...
public class AppToolbar : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler{
    ...
    public App InstantiateIcon(Type appType) {
        Type[] types = Type.EmptyTypes;
        ConstructorInfo constructorInfo = appType.GetConstructor(types);
        App app = (App) constructorInfo.Invoke(Array.Empty<object>());
